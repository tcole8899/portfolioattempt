    ...
    return (
      <p className="cmdtext">
        ...
        <ul>
          ...
          heaps, ques, hashtables, and trees.</li>
    ...
    return (
      <div className="terminal">
        ...
        <img
            ...
            alt=""
            className="x"
            onClick={this.toggleTerminalOff}
          />
        </header>
        <p className="cmdtext">Microsoft Windows [Version 10.0.5555.555] <br /> (c) 2019 Microsoft Corporation. All right reserved.</p>
        <p className="cmdtext">
          C:\Users\Tyler> <i>[*Press Enter for Info*]</i> {this.state.aboutMe ? this.renderAboutMe() : null} <b className="blink_me">_ </b>
        </p>
        <input className="enter" onKeyPress={this.keyPressed} autoFocus={true}>
        </input>
      </div>
    )
  }
